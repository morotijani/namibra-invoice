...
<head>
  ...
  <style>
    ...
    .meta td {
      width: 33.33%;
      padding: 14px 18px;
      background: #114232; /* Slightly lighter green for contrast */
      border: 1px solid #1c5440;
    }
    .meta .lbl {
    ...
    .tot-grand .lbl-g {
      float: left; font-size: 11px; letter-spacing: 1.5px; text-transform: uppercase; color: var(--gold-soft);
      line-height: 28px;
    }
    .tot-grand .v-g { float: right; font-family: 'DM Serif Display', serif; font-size: 24px; color: #fff; }

    .bottom {
      width: 100%; padding: 40px 52px 44px;
    }
    ...
    .momo-card {
      margin-top: 14px;
      background: #faf4e8; border: 1px solid #e7d4a3;
      border-radius: 9px; padding: 11px 14px;
    }
    .notes-text { font-size: 12.5px; line-height: 1.7; color: var(--ink-soft); }

    .footer {
      background: var(--green-deep); color: #ccc;
      padding: 18px 52px; font-size: 11.5px;
    }
  ...
  <div class="page">
    ...
    <div class="totals">
      <div class="totals-box">
        <div class="tot-row"><span class="lbl-t">Project Amount</span><span class="v"><?= formatCurrency($invoice['project_amount']) ?></span><div class="clear"></div></div>
        <div class="tot-grand">
          <span class="lbl-g">Total Due</span>
          <span class="v-g"><?= formatCurrency($invoice['total_due']) ?></span>
          <div class="clear"></div>
        </div>
      </div>
      <div class="clear"></div>
